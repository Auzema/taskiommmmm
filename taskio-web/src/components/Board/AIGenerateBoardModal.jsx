...
function AIGenerateBoardModal({ isOpen, handleClose, handleGenerate, isSubmitting }) {
    ...
    <Modal open={isOpen} onClose={onClose}>
      ...
      >
        ...
        <Typography sx={{ fontSize: 14, color: 'text.secondary', mb: 2 }}>
          Describe your project and AI will create a complete board with columns and cards.
        </Typography>
