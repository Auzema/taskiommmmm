        ...
        {!suggestions && !isGenerating && (
          <Stack spacing={2} sx={{ py: 1 }}>
            <Stack alignItems="center" spacing={1}>
              ...
              >
                Generate a description and subtasks from the card title using AI.
              </Typography>
            </Stack>
            ...
            {!showPromptInput ? (
              <Button
                ...
                sx={{ textTransform: 'none', fontSize: 13, color: '#7c3aed', alignSelf: 'center' }}
              >
                + Add extra context
              </Button>
            ) : (
          ...
          <Stack spacing={2}>
            ...
            <Box>
              <Typography sx={{ fontSize: 13, fontWeight: 600, color: 'text.secondary', mb: 0.5 }}>
                Subtasks ({selectedSubtasks.length}/{suggestions.subtasks.length})
              </Typography>
              <Stack spacing={0.5}>
